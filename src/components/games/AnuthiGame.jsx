...
export default function AnuthiGame({ onComplete }) {
  const [crises, setCrises] = useState([
    ...
    { id: 'saree', title: 'Saree Pleating Crisis', status: 'pending', question: 'Diwali is tonight and my saree pleats look like an accordion accident!', response: 'Anuthi Di: "Breathe. Bring it to my room right now. I will iron and pre-pleat the entire thing while you sleep. I got you covered, you will look beautiful!"' },
